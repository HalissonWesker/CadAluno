        ...
        <div class="col-md-12">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card card-outline-secondary">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="index.php?venda=store">
                            <div class="align-middle">
                                <div class="align-middle">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="cliente" id="cliente" class="form-control">
                                                <?php foreach ($clientes as $category) : ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="category">Produtos:</label>
                                        <div class="col-sm-12">
                                            <select multiple name="produto[]" id="produto" class="form-control">
                                                <?php foreach ($produtos as $produto) : ?>
                                                    <option value="<?php echo $produto->getId(); ?>"><?php echo $produto->getName(); ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    </div>
